                                                    ...
                                                    <div class="commentform">
                                                        <form class="row">
                                                         <div class="col-md-12 col-sm-12">
                                                                ...
                                                                <input type="text" name="fullname" class="form-control" placeholder="please enter fullname"  required />
                                                            </div>
                                                            <div class="col-md-12 col-sm-12">
                                                            ...
                                                            <div class="col-md-12 col-sm-12">
                                                                <label>Phone</label>
                                                                <input type="text" name="phone" class="form-control" placeholder="please enter phone"  required />
                                                            </div>
                                                             <div class="col-md-12 col-sm-12">
                                                           ...
                                                           <div class="col-md-12 col-sm-12">
                                                            ...
                                                            <div class="col-md-12 col-sm-12">
                                                                <input type="submit" name="submit" value="submit" class="btn btn-primary" />&nbsp;&nbsp;&nbsp; Already a member? <a class="btn btn-primary" href="login.php"> Login</a>
                                                            </div>
                                                        </form>
                                                    </div>
                                                    <!-- end newsletter -->
