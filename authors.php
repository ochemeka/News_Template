        ...
        <section class="section bgg">
            <div class="container">    
                <div class="title-area">
                    <h2>Authors <small class="hidden-xs">Contrary to popular belief, Lorem Ipsum is not simply random text..</small></h2>
                    <div class="bread">
                        <ol class="breadcrumb">
                            <li><a href="#">Home</a></li>
                                        ...
                                        <div class="col-sm-12 col-md-12">
                                            <div class="post clearfix">
                                                ...
                                                <div class="author-title desc">
                                                    <a href="single.html">Roy DOE - (53 Posts)</a>
                                                    <a class="authorlink" href="http://templatevisual.com">http://templatevisual.com</a>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12">
                                            <div class="post clearfix">
                                                <div class="avatar-author">
                                                    <a href="author.html">
                                                        <img alt="" src="upload/avatar_01.png" class="img-responsive">
                                                    </a>
                                                </div>
                                                <div class="author-title desc">
                                                    <a href="single.html">Kubra Karahasan - (211 Posts)</a>
                                                    <a class="authorlink" href="https://showwp.com">https://showwp.com</a>
                                                    <p>In ea voluptate velit esse quam nihil molestiae consequatur, vel ntium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo uis autnderit qui ..</p>
                                                    <ul class="list-inline authorsocial">
                                                        <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                                                        <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                                                        <li><a href="#"><i class="fa fa-google-plus"></i></a></li>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12">
                                            <div class="post clearfix">
                                                <div class="avatar-author">
                                                    <a href="author.html">
                                                        <img alt="" src="upload/avatar_03.jpg" class="img-responsive">
                                                    </a>
                                                </div>
                                                <div class="author-title desc">
                                                    <a href="single.html">Kubra Karahasan - (23 Posts)</a>
                                                    <a class="authorlink" href="https://www.junkiehost.com/">https://www.junkiehost.com</a>
                                                    <p>In ea voluptate velit esse quam nihil molestiae consequatur, vel ntium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo uis autnderit qui ..</p>
                                                    <ul class="list-inline authorsocial">
                                                        <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                                                        <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12">
                                            <div class="post clearfix">
                                                <div class="avatar-author">
                                                    <a href="author.html">
                                                        <img alt="" src="upload/avatar_04.jpg" class="img-responsive">
                                                    </a>
                                                </div>
                                                <div class="author-title desc">
                                                    <a href="single.html">Amy Anderson - (11 Posts)</a>
                                                    <a class="authorlink" href="https://www.junkiehost.com/">https://www.junkiehost.com</a>
                                                    <p>In ea voluptate velit esse quam nihil molestiae consequatur, vel ntium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo uis autnderit qui ..</p>
                                                    <ul class="list-inline authorsocial">
                                                        <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12">
                                            <div class="post clearfix">
                                                <div class="avatar-author">
                                                    <a href="author.html">
                                                        <img alt="" src="upload/avatar_05.jpg" class="img-responsive">
                                                    </a>
                                                </div>
                                                <div class="author-title desc">
                                                    <a href="single.html">Mark DOE - (11 Posts)</a>
                                                    <a class="authorlink" href="http://templatevisual.com">http://templatevisual.com</a>
                                                    <p>Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel ntium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo..</p>
                                                    <ul class="list-inline authorsocial">
                                                        <li><a href="#"><i class="fa fa-facebook"></i></a></li>
